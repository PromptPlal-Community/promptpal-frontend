...
export default function HowPPWorksCard({
  ...
  return (
    <div
      className={`flex items-center justify-between bg-white shadow-sm rounded-lg p-4 w-60 ${className}`}
    >
      <div className="flex-1">
        ...
        <div className="bg-gray-100 h-fit w-fit rounded-lg flex items-center justify-center overflow-hidden">
          {image ? (
            ...
            <>
              {imagePlaceholder.startsWith("http") ||
              imagePlaceholder.includes("/") ? (
                <img
                ...
                <span className="text-[#270450] font-bold text-center px-2">
                  {imagePlaceholder}
                </span>
              )}
            </>
