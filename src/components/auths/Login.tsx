      ...
      <div className="w-full md:w-3/5 flex flex-col items-center justify-center py-6 md:py-8 px-4 md:px-8">
        ...
        <div className="w-full max-w-sm md:max-w-md">
          ...
          <form
            ...
            className="rounded-lg p-6 md:p-8 w-full bg-white md:bg-transparent shadow-sm md:shadow-none border border-gray-100 md:border-none"
          >
            ...
            <button
              ...
              disabled={googleLoading || isAuthenticated()}
              className={`w-full flex items-center justify-center gap-2 border border-gray-300 py-3 rounded-lg transition-colors text-sm ${
                googleLoading || isAuthenticated()
            ...
            >
              ...
              ) : isAuthenticated() && hasGoogleAccount() ? (
                <>
